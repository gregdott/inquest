...
# To use, ensure the domain is correct. They spin up a vm for each lab, so the 0afd00ff0349988380ffb28600940005
# part will be different.

domain = "0afd00ff0349988380ffb28600940005.web-security-academy.net"
url = f"https://{domain}"
